    ...
    <>
      ...
      <div className="scroll overflow-hidden flex lg:my-20! bg-red-200/50">
        <ul className="flex gap-6 sm:gap-10 items-center !py-4 animate-[infinite-scroll_60s_linear_infinite]">
          {[...Array(3)].map((_, i) => (
            <>
              <li className="text-xl sm:text-2xl lg:text-3xl font-bold">
                <GiStarShuriken />
              </li>
      ...
      <div class="flex !my-20">
        <img
          src="assets/Untitled-1-20.jpg"
          className="h-1/4! w-3/6! lg:w-2/7! rounded-2xl lg:rounded-4xl lg:ms-60! ms-3! "
        />
        <div className="w-1/2 pe-1! lg:pe-0! lg:w-1/3 ps-3! lg:ps-20! flex flex-col !mt-5">
          ...
          <div className="flex justify-between mt-5! lg:mt-20! text-xs! lg:text-lg!">
            ...
            <Link to={"mailto:1998.sudik@gmail.com"}>1998.sudik@gmail.com</Link>
          </div>
